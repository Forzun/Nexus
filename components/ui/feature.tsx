    ...
    <section id="features" className="bg-gray-50 py-16 md:py-32 dark:bg-transparent">
      <div className="mx-auto max-w-5xl px-6">
        <div className="relative">
          <div className="relative z-10 grid grid-cols-6 gap-3 bg-background">
            ...
            <Card className=" col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
              <CardContent className="">
                <div className="flex justify-center bg">
                  <div className="flex justify-center w-[180px] h-[180px] overflow-hidden">
                    <Image
                      src="/features/richEditor.svg"
                ...
                <div className="relative z-10 mt-14 space-y-2 text-center">
                  ...
                  <p className="text-foreground">
                    More than just text. Add code blocks with syntax
                    highlighting, images, tables, checkboxes, and format text
                    with markdown.
                  </p>
                </div>
              </CardContent>
            ...
            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 ">
              <CardContent className="">
                ...
                <div className="relative z-10 mt-14 space-y-2 text-center">
                  ...
                  <p className="text-foreground">
                    Find anything instantly with powerful search that
                    understands context, searches through all your notes
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="grid pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-foreground">
                      More than just text. Add code blocks with syntax
                      highlighting, images, tables, checkboxes
                    </p>
                  </div>
                </div>
            ...
            <Card className="card variant-outlined relative col-span-full overflow-hidden lg:col-span-3">
              <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                    <Sparkles className="m-auto size-6" strokeWidth={1} />
                  </div>
                  <div className="space-y-2">
                    <h2 className="text-lg font-medium transition">
                    ...
                    <p className="text-foreground">
                      Let AI help you write better. Improve your text...
                    </p>
                  </div>
                </div>
                <div className="">
                  <Image
                    src="/features/Aibento.svg"
                    className="scale-200"
                    alt="search"
                    width={700}
                    height={700}
